...
├── legacy/
│   └── generate.py         # Original Python builder (archived)
├── cartpole.html          # Legacy single-file output (deprecated)
...
- **Original generator**: `legacy/generate.py` (archived)
- **Legacy output**: `cartpole.html` (deprecated - do not use)

The legacy files are preserved for reference but should not be used for new development.
...
- **npm**: 6.x or higher
- **No Python required** for development or running (Python was only needed for old generate.py)
